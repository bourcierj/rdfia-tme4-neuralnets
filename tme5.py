...
class CirclesData:
    ...
    def __init__(self):
        ...
        self._Xtrain = circles["Xtrain"].astype('float32')
        self._Xtest = circles["Xtest"].astype('float32')
        self._Ytrain = circles["Ytrain"].astype('float32')
        self._Ytest = circles["Ytest"].astype('float32')
